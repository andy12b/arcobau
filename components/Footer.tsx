        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 flex flex-col items-start w-full">
            ...
            <div className="space-y-4 w-full">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:contact@arcobau.ch" className="text-sm text-on-primary-container/80 hover:text-white transition-colors w-full">
                  contact@arcobau.ch
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+41440000000" className="text-sm text-on-primary-container/80 hover:text-white transition-colors w-full">
                  +41 44 000 00 00
                </a>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 flex flex-col w-full">
            ...
            <div className="flex gap-4">
              {/* Instagram */}
              <Link href="https://www.instagram.com/arcobau.gmbh" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-gold-ochre hover:border-gold-ochre transition-all duration-300 group" aria-label="Instagram">
              ...
              {/* TikTok */}
              <Link href="https://www.tiktok.com/@arcobau" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-gold-ochre hover:border-gold-ochre transition-all duration-300 group" aria-label="TikTok">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="group-hover:scale-110 transition-transform">
