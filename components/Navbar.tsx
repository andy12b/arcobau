        ...
        <div className={`md:hidden transition-all duration-500 bg-white border-t border-outline-variant/20 ${mobileOpen ? "max-h-[calc(100vh-80px)] overflow-y-auto py-6" : "max-h-0 overflow-hidden"}`}>
          <div className="px-margin-mobile flex flex-col gap-4">
            ...
            <div className="flex justify-center gap-6 mt-2">
              <a href="https://www.instagram.com/arcobau.gmbh" onClick={(e) => {
                if (typeof window !== "undefined" && /Mobi|Android|iPhone/i.test(navigator.userAgent)) {
                  e.preventDefault();
                  window.location.href = "instagram://user?username=arcobau.gmbh";
                  setTimeout(() => { window.location.href = "https://www.instagram.com/arcobau.gmbh"; }, 1000);
                }
              }} target="_blank" rel="noopener noreferrer" className="text-charcoal hover:text-gold-ochre transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@arcobau" onClick={(e) => {
                if (typeof window !== "undefined" && /Mobi|Android|iPhone/i.test(navigator.userAgent)) {
                  e.preventDefault();
                  window.location.href = "tiktok://user?screen_name=arcobau";
                  setTimeout(() => { window.location.href = "https://www.tiktok.com/@arcobau"; }, 1000);
                }
              }} target="_blank" rel="noopener noreferrer" className="text-charcoal hover:text-gold-ochre transition-colors" aria-label="TikTok">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61589457463612" onClick={(e) => {
                if (typeof window !== "undefined" && /Mobi|Android|iPhone/i.test(navigator.userAgent)) {
                  e.preventDefault();
                  window.location.href = "fb://profile/61589457463612";
                  setTimeout(() => { window.location.href = "https://www.facebook.com/profile.php?id=61589457463612"; }, 1000);
                }
              }} target="_blank" rel="noopener noreferrer" className="text-charcoal hover:text-gold-ochre transition-colors" aria-label="Facebook">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
